...
# Sorgenti
SRCS         := main.c build_in_cmd.c parsing.c signal.c token.c token_utils.c expand.c redirections.c utils.c find_cmd_path.c execution.c pipe.c execute_cmd.c echo_build.c
